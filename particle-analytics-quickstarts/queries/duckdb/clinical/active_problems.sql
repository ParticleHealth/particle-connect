...
SELECT
  ...
  END AS status_label,
  CAST("condition_onset_date" AS TIMESTAMPTZ) AS onset_date,
  CAST("condition_recorded_date" AS TIMESTAMPTZ) AS recorded_date,
  "condition_code",
...
ORDER BY
  ...
  CAST("condition_onset_date" AS TIMESTAMPTZ) DESC NULLS LAST;
